...
function main() {
  ...
  try {
    ...
    if (isDisabled('@deathbeds/jyve-js-unsafe-extension')) {
      disabled.matches.push('@deathbeds/jyve-js-unsafe-extension');
    } else {
      module = require('@deathbeds/jyve-js-unsafe-extension/');
      extension = module.default;
